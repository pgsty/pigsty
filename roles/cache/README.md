...
|--------------|-------------------------------------------------|
| EL9 x86_64   | `dist/v4.3.0/pigsty-pkg-v4.3.0.el9.x86_64.tgz`  |
...
tar -xzf pigsty-pkg-v4.3.0.el9.x86_64.tgz -C /www
...
./bootstrap -p /path/to/pigsty-pkg-v4.3.0.el9.x86_64.tgz
...
./cache.yml -l infra -e version=v4.3.0
