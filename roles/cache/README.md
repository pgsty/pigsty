...
|--------------|-------------------------------------------------|
| EL9 x86_64   | `dist/v4.2.2/pigsty-pkg-v4.2.2.el9.x86_64.tgz`  |
| EL8 aarch64  | `dist/v4.2.2/pigsty-pkg-v4.2.2.el8.aarch64.tgz` |
| Ubuntu 22.04 | `dist/v4.2.2/pigsty-pkg-v4.2.2.u22.x86_64.tgz`  |
| Ubuntu 24.04 | `dist/v4.2.2/pigsty-pkg-v4.2.2.u24.x86_64.tgz`  |
| Debian 12    | `dist/v4.2.2/pigsty-pkg-v4.2.2.d12.x86_64.tgz`  |
...
tar -xzf pigsty-pkg-v4.2.2.el9.x86_64.tgz -C /www
...
./bootstrap -p /path/to/pigsty-pkg-v4.2.2.el9.x86_64.tgz
