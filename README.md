...
[![Extensions: 572](https://img.shields.io/badge/extensions-572-%233E668F?style=flat&logo=postgresql&logoColor=white&labelColor=3E668F)](https://pigsty.io/ext/list)
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/pgsty/pigsty)

Enterprise-Grade Open-Source **PostgreSQL** Distribution with HA, PITR, IaC, Monitor, and 572 PG extensions.
...
- **Extensible**:   **572** [**PG Extensions**](https://pigsty.io/ext/list) & **12** [**PG Kernels**](https://pigsty.io/docs/pgsql/kernel) available, Packed for [**16 Linux Platforms**](https://pigsty.io/docs/ref/linux), Battery-Included.
...
- **Composable**:   Bonus [**Modules**](https://pigsty.io/docs/ref/module) such as [**Redis / Valkey**](https://pigsty.io/docs/redis), [**MinIO**](https://pigsty.io/docs/minio), [**Etcd**](https://pigsty.io/docs/etcd), [**Docker**](https://pigsty.io/docs/app), [**DuckDB**](https://pigsty.io/docs/pilot/duckdb), [**Supabase**](https://pigsty.io/docs/app/supabase), [**& More**](https://pigsty.io/docs/ref/module).
...
[![MONGO](https://img.shields.io/badge/MONGO-042133?style=flat&logo=ferretdb&labelColor=042133&logoColor=white)](https://pigsty.io/docs/conf/mongo)
...
|:------------------------------------------------------------:|:--------------------------------:|:--------------------------------------------------|
|  [PostgreSQL](https://pigsty.io/docs/pgsql/kernel/postgres)  |       **Battery-Included**       | Original PGDG PostgreSQL with 572 extensions      |
...
And gather the synergistic superpowers of all [**572 PostgreSQL Extensions**](https://pigsty.io/ext/list) all together:
...
and customize with scene-optimize [**config templates**](https://pigsty.io/docs/concept/iac/template) and all **572** [**extensions**](https://pigsty.io/ext/list) out-of-the-box.
