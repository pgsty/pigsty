...
Enterprise-Grade Open-Source **PostgreSQL** Distribution with HA, PITR, IaC, Monitor, and 555 PG extensions.
...
- **Extensible**:   **555** [**PG Extensions**](https://pigsty.io/ext/list) & **12** [**PG Kernels**](https://pigsty.io/docs/pgsql/kernel) available, Packed for [**16 Linux Platforms**](https://pigsty.io/docs/ref/linux), Battery-Included.
...
|:------------------------------------------------------------:|:--------------------------------:|:--------------------------------------------------|
|  [PostgreSQL](https://pigsty.io/docs/pgsql/kernel/postgres)  |       **Battery-Included**       | Original PGDG PostgreSQL with 555 extensions      |
...
And gather the synergistic superpowers of all [**555 PostgreSQL Extensions**](https://pigsty.io/ext/list) all together:
...
and customize with scene-optimize [**config templates**](https://pigsty.io/docs/concept/iac/template) and all **555** [**extensions**](https://pigsty.io/ext/list) out-of-the-box.
