...
(871, 'pg_parameters', '"postgres"', 'PGSQL', 'PG_BOOTSTRAP', 'string', 'C', 'extra parameters in postgresql.auto.conf', NULL),
...
(876, 'pg_io_method', '"auto"', 'PGSQL', 'PG_BOOTSTRAP', 'enum', 'C', 'io method for postgres: auto,sync,worker,io_uring, auto by default', NULL),
