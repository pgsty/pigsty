...
-- INFRA PARAMETERS
(101, 'version', '"v4.5.0"', 'INFRA', 'META', 'string', 'G', 'pigsty version string', NULL),
...
-- MINIO PARAMETERS
(600, 'minio_type', '"silo"', 'MINIO', 'MINIO', 'enum', 'G/C', 'object storage engine, currently fixed to silo', NULL),
