...
-- INFRA PARAMETERS
(101, 'version', '"v3.7.0"', 'INFRA', 'META', 'string', 'G', 'pigsty version string', NULL),
...
(109, 'infra_portal', '{"home": {"domain": "h.pigsty"}, "grafana": {"domain": "g.pigsty", "endpoint": "${admin_ip}:3000", "websocket": true}}', 'INFRA', 'INFRA_ID', 'dict', 'G', 'infra services exposed via portal', NULL),
...
(119, 'repo_url_packages', '[]', 'INFRA', 'REPO', 'string[]', 'G', 'extra packages from url', NULL),
...
(133, 'nginx_cert_validity', '"397d"', 'INFRA', 'NGINX', 'interval', 'G', 'nginx self-signed cert validity, 397d by default', NULL),
(134, 'nginx_home', '"/www"', 'INFRA', 'NGINX', 'path', 'G', 'nginx content dir, `/www` by default', NULL),
(135, 'nginx_port', '80', 'INFRA', 'NGINX', 'port', 'G', 'nginx listen port, 80 by default', NULL),
(136, 'nginx_ssl_port', '443', 'INFRA', 'NGINX', 'port', 'G', 'nginx ssl listen port, 443 by default', NULL),
(137, 'nginx_navbar', '[{"url": "/ca.crt", "desc": "pigsty self-signed ca.crt", "name": "CA Cert"}, {"url": "/pigsty", "desc": "local yum repo packages", "name": "Package"}, {"url": "/pigsty/pev.html", "desc": "postgres explain visualizer", "name": "Explain"}, {"url": "/logs", "desc": "postgres raw csv logs", "name": "PG Logs"}, {"url": "/report", "desc": "pgbadger summary report", "name": "Reports"}]', 'INFRA', 'NGINX', 'index[]', 'G', 'nginx index page navigation links', NULL),
...
(142, 'certbot_option', '""', 'INFRA', 'NGINX', 'arg', 'G/A', 'certbot extra options', NULL),
...
(155, 'victoria_clean', 'false', 'INFRA', 'VICTORIA', 'bool', 'G/A', 'whether clean existing victoria data during init?', NULL),
(156, 'victoria_data', '"/data/vm"', 'INFRA', 'VICTORIA', 'path', 'G', 'victoria top level data dir, `/data/vm` by default', NULL),
(157, 'victoria_sd_dir', '"/data/vm/targets"', 'INFRA', 'VICTORIA', 'path', 'G', 'victoria file service discovery directory', NULL),
(158, 'victoria_scrape_interval', '"10s"', 'INFRA', 'VICTORIA', 'interval', 'G', 'victoria global scrape interval, 10s by default', NULL),
(159, 'victoria_scrape_timeout', '"8s"', 'INFRA', 'VICTORIA', 'interval', 'G', 'victoria global scrape timeout, 8s by default', NULL),
(160, 'vmetrics_enabled', 'true', 'INFRA', 'VICTORIA', 'bool', 'G/I', 'enable victoria-metrics on this infra node?', NULL),
(161, 'vmetrics_clean', 'false', 'INFRA', 'VICTORIA', 'bool', 'G/A', 'whether clean existing victoria metrics data during init?', NULL),
(162, 'vmetrics_port', '8428', 'INFRA', 'VICTORIA', 'port', 'G', 'victoria-metrics listen port, 8428 by default', NULL),
(163, 'vmetrics_options', '"-retentionPeriod=15d -promscrape.fileSDCheckInterval=5s"', 'INFRA', 'VICTORIA', 'arg', 'G', 'victoria-metrics extra server options', NULL),
(164, 'vlogs_enabled', 'true', 'INFRA', 'VICTORIA', 'bool', 'G/I', 'enable victoria-logs on this infra node?', NULL),
(165, 'vlogs_clean', 'false', 'INFRA', 'VICTORIA', 'bool', 'G/A', 'clean victoria-logs data during init?', NULL),
(166, 'vlogs_port', '9428', 'INFRA', 'VICTORIA', 'port', 'G', 'victoria-logs listen port, 9428 by default', NULL),
(167, 'vlogs_options', '"-retentionPeriod=15d -retention.maxDiskSpaceUsageBytes=50GiB -insert.maxLineSizeBytes=1MB -search.maxQueryDuration=120s"', 'INFRA', 'VICTORIA', 'arg', 'G', 'victoria-logs extra server options', NULL),
(168, 'vtraces_enabled', 'true', 'INFRA', 'VICTORIA', 'bool', 'G/I', 'enable victoria-traces on this infra node?', NULL),
(169, 'vtraces_port', '10428', 'INFRA', 'VICTORIA', 'port', 'G', 'victoria-traces listen port, 10428 by default', NULL),
(170, 'vtraces_options', '"-retentionPeriod=15d -retention.maxDiskSpaceUsageBytes=50GiB"', 'INFRA', 'VICTORIA', 'arg', 'G', 'victoria-traces extra server options', NULL),
(171, 'vmalert_enabled', 'true', 'INFRA', 'VICTORIA', 'bool', 'G/I', 'enable vmalert on this infra node?', NULL),
(172, 'vmalert_port', '8880', 'INFRA', 'VICTORIA', 'port', 'G', 'vmalert listen port, 8880 by default', NULL),
(173, 'vmalert_options', '""', 'INFRA', 'VICTORIA', 'arg', 'G', 'vmalert extra server options', NULL),
(174, 'blackbox_enabled', 'true', 'INFRA', 'VICTORIA', 'bool', 'G/I', 'setup blackbox_exporter on this infra node?', NULL),
(175, 'blackbox_options', '""', 'INFRA', 'VICTORIA', 'arg', 'G', 'blackbox_exporter extra server options', NULL),
(176, 'exporter_metrics_path', '"/metrics"', 'INFRA', 'VICTORIA', 'path', 'G', 'exporter metric path, `/metrics` by default', NULL),
(177, 'exporter_install', '"none"', 'INFRA', 'VICTORIA', 'enum', 'G', 'how to install exporter? none,yum,binary', NULL),
(178, 'exporter_repo_url', '""', 'INFRA', 'VICTORIA', 'url', 'G', 'exporter repo file url if install exporter via yum', NULL),

(190, 'grafana_enabled', 'true', 'INFRA', 'GRAFANA', 'bool', 'G/I', 'enable grafana on this infra node?', NULL),
(191, 'grafana_clean', 'true', 'INFRA', 'GRAFANA', 'bool', 'G/A', 'clean grafana data during init?', NULL),
(192, 'grafana_admin_username', '"admin"', 'INFRA', 'GRAFANA', 'username', 'G', 'grafana admin username, `admin` by default', NULL),
(193, 'grafana_admin_password', '"pigsty"', 'INFRA', 'GRAFANA', 'password', 'G', 'grafana admin password, `pigsty` by default', NULL),
...
(236, 'node_kernel_modules', '["softdog", "ip_vs", "ip_vs_rr", "ip_vs_wrr", "ip_vs_sh"]', 'NODE', 'NODE_TUNE', 'string[]', 'C', 'kernel modules to be enabled on this node', NULL),
...
(510, 'etcd_safeguard', 'false', 'ETCD', 'ETCD_REMOVE', 'bool', 'G/C/A', 'prevents purging etcd instance? false by default', NULL),
(511, 'etcd_rm_data', 'true', 'ETCD', 'ETCD_REMOVE', 'bool', 'G/C/A', 'purging etcd data and config? true by default', NULL),
(512, 'etcd_rm_pkg', 'false', 'ETCD', 'ETCD_REMOVE', 'bool', 'G/C/A', 'uninstall etcd packages? false by default', NULL),
...
(870, 'pg_parameters', '"postgres"', 'PGSQL', 'PG_BOOTSTRAP', 'string', 'C', 'extra parameters in postgresql.auto.conf', NULL),
(871, 'pg_files', '[]', 'PGSQL', 'PG_BOOTSTRAP', 'path[]', 'C', 'extra files to be copied to postgres data directory (e.g. license)', NULL),
(872, 'pg_conf', '"oltp.yml"', 'PGSQL', 'PG_BOOTSTRAP', 'enum', 'C', 'config template: oltp,olap,crit,tiny. `oltp.yml` by default', NULL),
(873, 'pg_max_conn', '"auto"', 'PGSQL', 'PG_BOOTSTRAP', 'int', 'C', 'postgres max connections, `auto` will use recommended value', NULL),
(874, 'pg_shared_buffer_ratio', '0.25', 'PGSQL', 'PG_BOOTSTRAP', 'float', 'C', 'postgres shared buffer memory ratio, 0.25 by default, 0.1~0.4', NULL),
(875, 'pg_rto', '30', 'PGSQL', 'PG_BOOTSTRAP', 'int', 'C', 'recovery time objective in seconds,  `30s` by default', NULL),
...
(883, 'pgsodium_key', NULL, 'PGSQL', 'PG_BOOTSTRAP', 'string', 'C', 'pgsodium key, 64 hex digit, default to sha256(pg_cluster) if not specified', NULL),
(884, 'pgsodium_getkey_script', NULL, 'PGSQL', 'PG_BOOTSTRAP', 'path', 'C', 'pgsodium getkey script path, `pgsodium_getkey` in template by default', NULL),
