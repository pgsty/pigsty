...
-- INFRA PARAMETERS
(101, 'version', '"v3.6.0"', 'INFRA', 'META', 'string', 'G', 'pigsty version string', NULL),
...
(164, 'prometheus_sd_interval', '"5s"', 'INFRA', 'PROMETHEUS', 'interval', 'G', 'prometheus target refresh interval, 5s by default', NULL),
(165, 'prometheus_scrape_interval', '"10s"', 'INFRA', 'PROMETHEUS', 'interval', 'G', 'prometheus scrape & eval interval, 10s by default', NULL),
(166, 'prometheus_scrape_timeout', '"8s"', 'INFRA', 'PROMETHEUS', 'interval', 'G', 'prometheus global scrape timeout, 8s by default', NULL),
(167, 'prometheus_options', '"--storage.tsdb.retention.time=15d"', 'INFRA', 'PROMETHEUS', 'arg', 'G', 'prometheus extra server options', NULL),
(168, 'pushgateway_enabled', 'true', 'INFRA', 'PROMETHEUS', 'bool', 'G/I', 'setup pushgateway on this infra node?', NULL),
(169, 'pushgateway_options', '"--persistence.interval=1m"', 'INFRA', 'PROMETHEUS', 'arg', 'G', 'pushgateway extra server options', NULL),
...
(179, 'exporter_repo_url', '""', 'INFRA', 'PROMETHEUS', 'url', 'G', 'exporter repo file url if install exporter via yum', NULL),

(180, 'grafana_enabled', 'true', 'INFRA', 'GRAFANA', 'bool', 'G/I', 'enable grafana on this infra node?', NULL),
(181, 'grafana_clean', 'true', 'INFRA', 'GRAFANA', 'bool', 'G/A', 'clean grafana data during init?', NULL),
(182, 'grafana_admin_username', '"admin"', 'INFRA', 'GRAFANA', 'username', 'G', 'grafana admin username, `admin` by default', NULL),
(183, 'grafana_admin_password', '"pigsty"', 'INFRA', 'GRAFANA', 'password', 'G', 'grafana admin password, `pigsty` by default', NULL),
(186, 'loki_enabled', 'true', 'INFRA', 'LOKI', 'bool', 'G/I', 'enable loki on this infra node?', NULL),
(187, 'loki_clean', 'false', 'INFRA', 'LOKI', 'bool', 'G/A', 'whether remove existing loki data?', NULL),
(188, 'loki_data', '"/data/loki"', 'INFRA', 'LOKI', 'path', 'G', 'loki data dir, `/data/loki` by default', NULL),
(189, 'loki_retention', '"15d"', 'INFRA', 'LOKI', 'interval', 'G', 'loki log retention period, 15d by default', NULL),
...
(510, 'etcd_safeguard', 'false', 'ETCD', 'ETCD_REMOVE', 'bool', 'G/C/A', 'prevent purging running etcd instance?', NULL),
(511, 'etcd_rm_data', 'true', 'ETCD', 'ETCD_REMOVE', 'bool', 'G/C/A', 'purging existing etcd during initialization?', NULL),
(511, 'etcd_rm_pkg', 'false', 'ETCD', 'ETCD_REMOVE', 'bool', 'G/C/A', 'uninstall etcd packages? false by default', NULL),
...
(604, 'minio_https', 'true', 'MINIO', 'MINIO', 'bool', 'G/C', 'use https for minio, false will use http', NULL),
(605, 'minio_user', '"minio"', 'MINIO', 'MINIO', 'username', 'C', 'minio os user, `minio` by default', NULL),
(606, 'minio_node', '"${minio_cluster}-${minio_seq}.pigsty"', 'MINIO', 'MINIO', 'string', 'C', 'minio node name pattern', NULL),
(607, 'minio_data', '"/data/minio"', 'MINIO', 'MINIO', 'path', 'C', 'minio data dir(s), use {x...y} to specify multi drivers', NULL),
(608, 'minio_domain', '"sss.pigsty"', 'MINIO', 'MINIO', 'string', 'G', 'minio service domain name, `sss.pigsty` by default', NULL),
(609, 'minio_port', '9000', 'MINIO', 'MINIO', 'port', 'C', 'minio service port, 9000 by default', NULL),
(610, 'minio_admin_port', '9001', 'MINIO', 'MINIO', 'port', 'C', 'minio console port, 9001 by default', NULL),
