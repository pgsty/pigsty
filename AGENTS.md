...
- `extension.md` - Complete catalog of 575 PostgreSQL extensions with installation instructions
...
#### Ext `/docs/pgsql/ext/`
PostgreSQL extension management. Pigsty supports 575 extensions out of the box.
