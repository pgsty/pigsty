...
- `extension.md` - Complete catalog of 572 PostgreSQL extensions with installation instructions
...
#### Ext `/docs/pgsql/ext/`
PostgreSQL extension management. Pigsty supports 572 extensions out of the box.
...
### PIG `/docs/pig/`
PIG v1.5.1 package manager for PostgreSQL extensions. Command-line tool for discovering, installing, and managing the 572 extensions available in the Pigsty ecosystem.
